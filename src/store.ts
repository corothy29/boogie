...
1. 사업 개요
AI 기반 스타트업 재무·회계 통합 운영체제 '부기(Boogie)'를 개발·운영 중이며,
Zero-Touch 회계 자동화로 초기 스타트업의 행정 비용을 70% 절감합니다.
...
※ 본 문서는 AI가 자동 생성한 초안입니다. 검토 후 제출하세요.`;
}
...
export function getAiInsight(state: BoogieState, metrics: ReturnType<typeof computeMetrics>): string {
  ...
  return "재무 상태가 안정적입니다. 이번 달 소진율을 모니터링 중입니다.";
}
